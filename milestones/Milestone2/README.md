...
1.Revised Section III and added additional database requirements to satisify requirements going both ways

2.Indicated which entities are strong and weak 

3.Revamped the ERD and changed the names of the attributes for easy comprehension. Revised the relationship between some entities. 
